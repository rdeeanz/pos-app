      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-zinc-900 tracking-tight leading-none">Point of Sale</h1>
              <p className="text-[10px] font-medium text-blue-600 uppercase tracking-widest mt-1">Terminal Active</p>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                ...
                <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-tighter">{user?.role || 'Staff'}</p>
              </div>
